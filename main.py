...
#===================Python Variables=======================
menu_category = ["Fertilizer","Pesticide","Herbicide","Organic ","Seeds","Compost","Farm Equipments"]

menu_category_dict = {"Fertilizer":"1 Fertilizer.txt","Pesticide":"2 Beverages.txt",
                "Herbicide":"3 Herbicide.txt","Organic ":"4 Organic .txt",
                "Seeds":"5 Seeds.txt","Compost":"6 Compost.txt",
                "Farm Equipments":"7 Farm Equipments.txt"}
...
root.title("Welcome to Agriclinic")
...
title_label = Label(title_frame, text="Agriclinic", 
                    font=("times new roman", 20, "bold"),bg = "skyblue", fg="red", pady=5)
title_label.pack()
...
#===============Menu===============
menu_frame = Frame(root,bd=8, bg="lightpink", relief=GROOVE)
menu_frame.place(x=0,y=125,height=585,width=680)

menu_label = Label(menu_frame, text="Menu", 
                    font=("times new roman", 20, "bold"),bg = "lightpink", fg="red", pady=0)
menu_label.pack(side=TOP,fill="x")

menu_category_frame = Frame(menu_frame,bg="lightpink",pady=10)
menu_category_frame.pack(fill="x")

combo_lable = Label(menu_category_frame,text="Select Type", 
                    font=("arial", 12, "bold"),bg = "lightpink", fg="blue")
...
#===============Item Frame=============
item_frame = Frame(root,bd=8, bg="lightpink", relief=GROOVE)
item_frame.place(x=680,y=125,height=230,width=680)

item_title_label = Label(item_frame, text="Item", 
                    font=("times new roman", 20, "bold"),bg = "lightpink", fg="red")
item_title_label.pack(side=TOP,fill="x")

item_frame2 = Frame(item_frame, bg="lightpink")
...
item_frame3 = Frame(item_frame, bg="lightpink")
...
#==============Order Frame=====================
order_frame = Frame(root,bd=8, bg="lightpink", relief=GROOVE)
